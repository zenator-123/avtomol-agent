...
const PART_TYPES = {
  vehicles: [
    ...
    "търся автомобил",
    "продавате ли коли",
    "продавате ли автомобили",
    "автомобили втора употреба",
    "налични автомобили",
    "кола за продажба",
    "автомобил за продажба",
    "buy a car",
    "used car",
    "available vehicles",
    "gebrauchtwagen"
  ...
  parts: [
    ...
    "крушка",
    "крушки",
    "закрепване на джанти",
    "izpuskatelna sistema",
    "gorivni markuchi",
    "diftungi",
    "kare krastachka",
    "kare vanshno",
    "chasti po dvigatelya",
    "lager",
    "lageri",
    "klapan",
    "klapani",
...
function inferProductPartTypes(product, haystack) {
  if (
    product.isVehicle === true ||
    normalizeArray(product.tags).some((tag) => normalizeText(tag) === "vehicle sync") ||
    normalizeText(product.productType) === "with mileage"
  ) {
    return ["vehicles"];
  }
